...
void quick(){
  TFile* file = new TFile("2gamma5k0T.root");
  TFile* file1 = new TFile("3gamma5k0T.root");
  TFile* file2 = new TFile("radBhabha5k0T.root");
  TFile* file3 = new TFile("bhabha5k0T.root");
